...
class OnBeanCondition extends FilteringSpringBootCondition implements ConfigurationCondition {
	...
	private static final String AND = " and ";  // Compliant
	@Override
	...
	private void getMatchesForTypes(ClassLoader classLoader, boolean considerHierarchy,
										   ConfigurableListableBeanFactory beanFactory, Set<String> types,
										   Set<Class<?>> parameterizedContainers, Set<String> beansIgnoredByType,
										   MatchResult result) {
